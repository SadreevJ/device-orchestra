...
class TestFakeDevice:
    ...
    def test_motor_commands(self):
        motor_device = FakeDevice(
            "test_motor",
            {"device_type": "motor", "base_delay": 0.01, "error_probability": 0.0},
        )
    ...
    def test_error_simulation(self):
        error_device = FakeDevice(
            "error_device",
            {"device_type": "camera", "base_delay": 0.01, "error_probability": 1.0},
        )
