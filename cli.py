...
def main():
    parser = argparse.ArgumentParser(
        description="UCDF - Universal Device Control & Debug Framework",
        prog="ucdf"
    )
    ...
    pipeline_parser.add_argument("--dry-run", action="store_true", help="Режим симуляции (без реального выполнения)")
